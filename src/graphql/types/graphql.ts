...
export type QueryReadoutsArgs = {
  ...
  metricIds?: InputMaybe<Array<Scalars['ID']['input']>>;
...
export type MBusRecordFragment = { __typename?: 'MBusRecord', device?: number | null, function?: string | null, id: number, storageNumber?: number | null, tariff?: number | null, timestamp: any, unit?: string | null, value?: Big | null } & { ' $fragmentName'?: 'MBusRecordFragment' };
...
export type MeasPointDetailCorrectionFragment = { __typename?: 'Correction', id: string, value: Big, oldMeterEndValue?: Big | null, newMeterStartValue?: Big | null, oldMeterHasPhysicalDisplay?: boolean | null, oldMeterMbusValueRecordId?: number | null, oldMeterMbusDecimalShift?: number | null, createdUTCTime: any, metric: { __typename?: 'Metric', id: string, type: MetricType } } & { ' $fragmentName'?: 'MeasPointDetailCorrectionFragment' };

export type MeasPointDetailServiceEventFragment = { __typename?: 'ServiceEvent', id: string, type: ServiceEventType, occuredUTCTime: any, oldMbusAddr?: number | null, oldMbusSerial?: string | null, oldMeterManufacturer?: string | null, oldMeterType?: string | null, comments?: string | null, createdUTCTime: any, corrections: Array<(
    { __typename?: 'Correction' }
...
export type MeasPointDetailMetricFragment = { __typename?: 'Metric', id: string, type: MetricType, func: MetricFunc, hasPhysicalDisplay: boolean, mbusValueRecordId?: number | null, mbusDecimalShift?: number | null, createdUTCTime: any } & { ' $fragmentName'?: 'MeasPointDetailMetricFragment' };
...
export type MeasPointListMetricFragment = { __typename?: 'Metric', id: string, type: MetricType, func: MetricFunc, hasPhysicalDisplay: boolean, mbusValueRecordId?: number | null, mbusDecimalShift?: number | null, createdUTCTime: any } & { ' $fragmentName'?: 'MeasPointListMetricFragment' };

export type MeasPointListServiceEventFragment = { __typename?: 'ServiceEvent', id: string, type: ServiceEventType, occuredUTCTime: any, oldMbusAddr?: number | null, oldMbusSerial?: string | null, oldMeterManufacturer?: string | null, oldMeterType?: string | null, comments?: string | null, createdUTCTime: any } & { ' $fragmentName'?: 'MeasPointListServiceEventFragment' };
...
export type ReadoutListFragment = { __typename?: 'Readout', id: string, type: ReadoutType, source: ReadoutSource, value: Big, errCode?: MBusReadoutErrCode | null, errDetail?: string | null, meterUTCTimestamp?: any | null, createdUTCTime: any, metric: { __typename?: 'Metric', id: string, type: MetricType } } & { ' $fragmentName'?: 'ReadoutListFragment' };

export type ReadoutsQueryVariables = Exact<{
  take: Scalars['Int']['input'];
  skip: Scalars['Int']['input'];
  metricIds?: InputMaybe<Array<Scalars['ID']['input']> | Scalars['ID']['input']>;
  from?: InputMaybe<Scalars['DateTimeISO']['input']>;
  to?: InputMaybe<Scalars['DateTimeISO']['input']>;
}>;
...
export type SerieEntryFrgFragment = { __typename?: 'SerieEntry', metricId: number, value: Big, timestampUTC: any } & { ' $fragmentName'?: 'SerieEntryFrgFragment' };
